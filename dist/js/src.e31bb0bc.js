...
},{}],"../node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
function fetchCountries(countryName) {
  return fetch(`${ENTRY_POINT}/name/${countryName}?fields=name,capital,population,flags,languages`).then(r => {
    if (r.ok) {
      return r.json();
    } else {
...
},{}],"js/createListMarkup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createListMarkup = createListMarkup;
...
},{}],"js/createCardMarkup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createCardMarkup = createCardMarkup;
...
var _createListMarkup = require("./js/createListMarkup");

var _createCardMarkup = require("./js/createCardMarkup");
...
input.addEventListener('input', (0, _lodash.default)(onInputChange, DEBOUNCE_DELAY));
...
function onInputChange(e) {
  ...
  (0, _fetchCountries.fetchCountries)(searchQuery).then(data => {
    const elementsQuantity = data.length;

    if (elementsQuantity > 10) {
      _notiflix.default.Notify.warning('Too many matches found. Please enter a more specific name.');

      return;
    } else if (10 > elementsQuantity && elementsQuantity > 1) {
      const markup = (0, _createListMarkup.createListMarkup)(data);
      updateMarkup(markup);
    } else {
      const markup = (0, _createCardMarkup.createCardMarkup)(data);
      updateMarkup(markup);
    }
  }).catch(() => _notiflix.default.Notify.failure('Oops, there is no country with that name'));
}

function updateMarkup(markup = '') {
  countryList.innerHTML = markup;
}
},{"./css/styles.css":"css/styles.css","lodash.debounce":"../node_modules/lodash.debounce/index.js","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js","./js/fetchCountries":"js/fetchCountries.js","./js/createListMarkup":"js/createListMarkup.js","./js/createCardMarkup":"js/createCardMarkup.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
